...
- **주제 재생성**: 제안된 주제가 마음에 안 들면 새로운 주제 요청 가능
- **글쓰기 방향 설정**: 글의 방향/의도를 직접 입력하여 AI에 전달
...
2. AI가 수집된 소재를 분석하여 **주제 3가지 제안**
   - 마음에 안 들면 **"🔄 Regenerate Topics"** 클릭하여 새로운 주제 요청
3. 마음에 드는 주제 선택 → **"Next"** 클릭
4. **페르소나 선택** (에세이, 블로그, 학술, 트위터 등)
5. **글쓰기 방향 입력** (선택사항)
   - "실용적인 적용에 초점을 맞춰줘"
   - "X와 Y의 연결을 강조해줘"
   - "초보자도 이해할 수 있게 써줘" 등
6. **"Generate Article"** 클릭 → AI가 당신의 소재, 생각, 방향을 반영하여 글 초안 생성
